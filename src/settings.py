...
class Settings(BaseSettings):
    ...
    MARKDOWN_OUTPUT_PATH: str = Field(default="reports/rca_report.md", description="Path for the RCA Markdown report.")
    ...
    MAX_INVESTIGATION_CYCLES: int = Field(default=1, description="Maximum bounded investigation cycles to run.")
